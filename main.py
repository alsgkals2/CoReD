...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', '-m', type=str, default='net_m',choices=['net','KD','TG','FT','net_m'])
    ...
    parser.add_argument('--network', '-n', type=str, default='Xception_modify',choices=['Xception','Efficient', 'Xception_modify'], help='Choose the one of [Xception, Efficient]')
    ...
    parser.add_argument('--name_folder1', '-folder1', type=str, default='modify', help='name of folder that will be made')
    ...
    args.folder_weight = args.folder_weight.replace(f'/_{args.name_target}/', f'/{args.name_target}/') \
                                                    if f'/_{args.name_target}/' in args.folder_weight else args.folder_weight
